...
import 'package:zob/home/view/news/news_details_screen.dart';
...
class _NewsScreenState extends State<NewsScreen> {
  ...
  RxList<NewsList> newsList = <NewsList>[].obs;

  fetchBlogPosts() async {
    isLoading.value = true;
    await Api.newsApis().then((response) {
      if (response != null) {
        NewsListApiResponseModel blogListApiResponseModel =
            NewsListApiResponseModel.fromJson(response);
        if (blogListApiResponseModel.success == true) {
          newsList.value = blogListApiResponseModel.data ?? [];
        }
      }
    });
